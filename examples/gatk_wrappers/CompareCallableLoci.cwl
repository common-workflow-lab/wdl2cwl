...

{
    "inputs": [
        ...
        },
        {
            "id": "comp1",
            "type": "string",
            "doc": "First comparison track name"
        },
        {
            "id": "comp2",
            "type": "string",
            "doc": "Second comparison track name"
        },
        {
            "id": "out",
            "type": "string?",
        ...
        },
        {
            "id": "printstate",
            "type": "string?",
            "doc": "If provided, prints sites satisfying this state pair"
        }
    ],
    "id": "CompareCallableLoci",
    "baseCommand": [],
    ...
    "arguments": [
        {
            "valueFrom": "\t\tjava -jar $(inputs.gatk.path) \\\t\t\t-T CompareCallableLoci \\\t\t\t-R $(inputs.ref.path) \\\t\t\t$(\"--intervals \" + inputs.intervals) \\\t\t\t-comp1 $(inputs.comp1) \\\t\t\t-comp2 $(inputs.comp2) \\\t\t\t-o $(inputs.out) \\\t\t\t$(\"-printState \" + inputs.printstate) \\\t\t\t$(inputs.userString) \t",
            "shellQuote": false
        }
    ],
    "cwlVersion": "v1.0"
